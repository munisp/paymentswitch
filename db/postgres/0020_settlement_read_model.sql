...
CREATE INDEX IF NOT EXISTS settlement_batches_status_window_idx
  ON settlement_batches (status, window_opened_at DESC);
CREATE INDEX IF NOT EXISTS settlement_batches_participant_window_idx
  ON settlement_batches (participant_id, window_opened_at DESC);
CREATE INDEX IF NOT EXISTS settlement_batches_bank_window_idx
  ON settlement_batches (bank_code, window_opened_at DESC);
...
CREATE INDEX IF NOT EXISTS settlement_events_batch_time_idx
  ON settlement_events (settlement_batch_id, occurred_at ASC);
